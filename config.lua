...
local reports_group = {
  ...
  args = {
    ...
    d1 = {
      ...
      type = "description",
      name =
      "Scambuster allows you to specify the kinds of reports that will trigger an alert, if your list provider supports this functionality.",
    },
    h2 = {
      order = 2.0,
      type = "header",
    ...
    d4 = {
      ...
      type = "description",
      name =
          "Scambuster's lists support both player names and Globally Unique Identifiers (GUIDs). Player names can be changed," ..
    ...
    match_all_incidents = {
      ...
      desc =
          "If Require GUID Match is enabled, enabling this option will also print name-only case matches corresponding " ..
...
local alerts_opts_group = {
  ...
  args = {
    ...
    d1 = {
      ...
      type = "description",
      name =
      "To avoid spam, Scambuster will only generate warnings for a given scammer once per a lockout period, configurable below.",
    },
    ...
    use_system_alert = {
      ...
      name = "System Message",
      desc =
      "If enabled, Scambuster will print a summary of the scammer's information as a system message when an alert is raised.",
      get = "opts_getter",
      set = "opts_setter"
    },
    ...
    print_descriptions_in_alerts = {
      ...
      desc =
      "If enabled, the description of the scam incident will also be printed in text alerts, if one is given by the provider.",
      get = "opts_getter",
      set = "opts_setter",
    },
    h3 = {
...
SB.options = {
  ...
  args = {
    ...
    server_name = {
      ...
      order = 1.1,
      name = "Server name",
      desc = "Set or change the server name (e.g. Warmane).",
      get = function(info)
        return SB.db.global[info[#info]]
      end,
      set = function(info, value)
        SB.db.global[info[#info]] = value
      end
    },
    is_crossfaction = {
      type = "toggle",
      ...
      order = 1.2,
      name = "Crossfaction",
      desc = "Receive crossfaction alerts",
      get = function(info)
        return SB.db.realm[info[#info]]
      end,
      set = function(info, value)
        SB.db.realm[info[#info]] = value
      end
    },
    welcome_message = {
      type = "toggle",
